...
import CurioCamp from "../assets/logo_transparent.png";
...
export default function Footer() {
  ...
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 mb border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            Curiocamp: A dynamic online learning community offering curated content and collaborative study groups for lifelong learners.
            </div>
        ...
        <div className="my-10 text-sm text-center text-gray-600">
          Copyright © {new Date().getFullYear()}. Made with Efforts 🫡 by{" "}
          <a
